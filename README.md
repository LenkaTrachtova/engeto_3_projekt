...
## Project Description
This project extracts election results from the Czech parliamentary elections (2017).  
The script downloads data from the official website **volby.cz**, processes all municipalities in a selected district, and saves the results into a CSV file.

The project was created as part of the Engeto Python Academy.
